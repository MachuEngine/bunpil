...
아래 3개가 헤드라인입니다(생성 Qwen2.5-14B / Judge gpt-5.6-luna — 현재 배포 구성과 동일). Judge 신뢰도·문항 품질은 2026-07-24(judge 분리 후 첫 정식 측정), 검색 Recall@5/MRR은 2026-08-03(`n_candidates` 조정 후, 더 최신) 기준이라 날짜가 섞여 있습니다.
